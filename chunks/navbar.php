		...
		<nav>
		    <div class="nav-wrapper">
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number  +212644445045. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
	        ...
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number  +212644445045. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
